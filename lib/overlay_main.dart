...
class _OverlayAppState extends State<OverlayApp> {
  ...
  void initState() {
    ...
    _messages.add(
      ChatMessage(
        role: 'assistant',
        content:
            'Hi! I am your Neutral Pip. Ask me to perform any task on your screen.',
      ),
    );
  }
  ...
  Future<void> _initializeServices() async {
    ...
    final intent = const AndroidIntent(
      action: 'com.neutralpip.app.REGISTER_BACKGROUND_CHANNELS',
  ...
  Future<void> _openMainApp() async {
    ...
    const intent = AndroidIntent(
      ...
      package: 'com.neutralpip.app',
      componentName: 'com.neutralpip.app.MainActivity',
      flags: <int>[
